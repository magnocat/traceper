...
EOT;
    ...
    public static function getMainPage($callbackURL, $fetchPhotosInInitialization, $updateUserListInterval, $queryIntervalForChangedUsers, $language) {
...
<html>
        ...
        <script type="text/javascript">
                ...
                $(document).ready( function(){
                       ...
                       var latlng = new google.maps.LatLng(39.504041,35.024414);
    				   var myOptions = {
					        zoom: 3,
					        center: latlng,
