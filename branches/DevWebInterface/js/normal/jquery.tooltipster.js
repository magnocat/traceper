...
;(function ($, window, document) {
	...
	var pluginName = "tooltipster",
		defaults = {
			...
			content: null,
			//contentAsHTML: false,
			contentAsHTML: true, //ADNAN: (default:false)
			contentCloning: true,
			delay: 200,
			fixedWidth: 0,
			maxWidth: 0,
			...
			touchDevices: true,
			trigger: 'hover',
			updateAnimation: false, //ADNAN: (default:true)
			zIndex: 500
		};
			...
			self.options.functionBefore.call(self.$el, self.$el, function() {
				...
				if (self.enabled && self.content !== null) {
					...
					// if the tooltip isn't already open, open that sucker up!
						...
						//ADNAN: z-index:' + self.options.zIndex + ';' part added
						self.$tooltip = $('<div class="tooltipster-base '+ self.options.theme +'" style="z-index:' + self.options.zIndex + ';'+ fixedWidth +' '+ maxWidth +' '+ pointerEvents +' '+ animationSpeed +'"><div class="tooltipster-content"></div></div>');
						...
						//ADNAN: Do not reposition on scroll
...
//						});
		...
		positionTooltip: function() {
			...
			//alert("positionTooltip() called");
			
			// in case the tooltip has been removed from DOM manually
			if ($('body').find(self.$tooltip).length !== 0) {
				
				// reset width
				//ADNAN: Pencereyi kucultunce kuculmemesi icin resetleme
				...
				if(practicalPosition == 'left') {
					...
					//ADNAN: Do not flip it to the other side
