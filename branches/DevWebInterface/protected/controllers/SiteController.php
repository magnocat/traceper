...
// 	}
	...
	//Mobilde gonderilecek parametreler: email, fbId, password, language 
	public function actionFacebookLogin()
	{
		...
		{			
			...
			//$this->renderPartial('acceptTermsForFacebookLogin',array(), false, true/*$processOutput*/);
			Yii::app()->end();
		}
		
		$this->commonLogin($fbEmail, $autoGeneratedPassword, $language, false/*$directLogin*/);
	}
	...
	public function actionContinueFacebookLogin() 
	{
		...
		if (Users::model()->saveFacebookUser($fbEmail, md5($autoGeneratedPassword), $name, $fbId, 1/*account_type*/, $registrationMedium, $language)) 
		{
			...
			echo CJSON::encode(array("result"=> "-1")); //User cannot be registered
			Yii::app()->end();
		}
	}
